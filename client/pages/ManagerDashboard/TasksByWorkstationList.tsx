...
export function TasksByWorkstationList({
  ...
  if (values.length === 0) {
    return (
      <div className="text-center py-16 glass-card rounded-2xl border border-border/60 shadow-md transition-all duration-300">
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      {values.map((workstation) => (
        <div
          key={workstation.id}
          className="border-t border-border/70 pt-6 md:pt-8 first:border-t-0 first:pt-0"
        >
