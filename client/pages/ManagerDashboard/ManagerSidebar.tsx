...
import { LogOut, Settings, Users, Gauge, Calendar, LayoutDashboard, Monitor, ListTodo } from "lucide-react";
...
export function ManagerSidebar({
    ...
    return (
        <aside className="w-64 flex-shrink-0 min-h-screen glass-panel border-r flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-20">
